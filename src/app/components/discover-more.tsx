    ...
    >
      ...
      >
        ...
        <Text my="3rem" w={{ base: "100%", lg: "70%" }} mx="auto">
          Immerse yourself in a world of unparalleled visual delight as we bring
          you the finest in viewing experiences, ensuring that each moment is a
          celebration of exceptional visual enjoyment.
        </Text>
